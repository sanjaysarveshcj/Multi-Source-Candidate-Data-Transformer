...
### 3. LinkedIn Transform (`/transform/linkedin`)
Extracts candidate data from a LinkedIn profile URL.

#### Without Projection Layer
**CLI (cURL)**
```bash
curl -X POST "http://127.0.0.1:8000/transform/linkedin" \
     -d "linkedin_url=https://linkedin.com/in/williamgates"
```
**Sample Input**
...
{
  "success": true,
  "requestId": "b13a8603-0c48-406a-a719-741c881c9a13",
  "processingTimeSeconds": 0.3,
  "data": {
    "candidate": {
      "full_name": "Bill Gates",
      "links": { "linkedin": "linkedin.com/in/williamgates" },
      "experience": [
        {
          "company": "Microsoft",
          "title": "Co-founder"
...
curl -X POST "http://127.0.0.1:8000/transform/linkedin" \
     -d "linkedin_url=https://linkedin.com/in/williamgates" \
     -d 'projection_config={"fields": [{"path": "name", "from": "full_name", "type": "string"}]}'
```
**Sample Input**
`linkedin_url` and `projection_config` form fields.

**Sample Output**
```json
{
  "success": true,
  "requestId": "c92d5ab8-b80c-40ad-bc1f-829d5ca0d2f6",
  "processingTimeSeconds": 0.3,
  "data": {
    "name": "Bill Gates"
  }
